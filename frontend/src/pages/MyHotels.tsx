							...
							>
								...
								<span className="flex justify-end gap-4">
									<button
										...
										className="bg-red-500 hover:bg-red-400 font-bold py-2 px-4 rounded-md text-xl text-white"
										disabled={isLoading}
									>
										Delete
									</button>
									<Link
										...
										className="bg-zinc-400 hover:bg-zinc-300 font-bold py-2 px-4  rounded-md text-xl text-white"
									>
										View Details
									</Link>
								</span>
